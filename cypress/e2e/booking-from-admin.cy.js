describe('Booking from admin hall name', () => {
  ...
  it('Book ticket in hall from admin', () => {
    ...
    // Из за ошибки showPopup is not defined я офмфне могу корректно войти в админку: если я ее игнорирую, то у меня запускается пустая админка и тест просто не видит нужный селектор, если я не игнорирую данную ошибку, то у меня просто не происодит авторизация
